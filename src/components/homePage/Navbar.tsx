  ...
  return (
    <Container>
      <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm my-4  sticky top-0  ">
        <nav
          className=" relative max-w-[85rem] w-full bg-white  backdrop-blur-md bg-opacity-70   border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700"
          aria-label="Global"
        >
